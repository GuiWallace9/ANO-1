...
/*FUNÇÃO PARA CALCULAR O COSSENO ATRAVÉS DA SÉRIE DE TAYLOR*/
...
int main() {
  ...
  while (cont < n) {
    ...
    if (!teste_localiza2 || !teste_localiza1) {
      ...
      if (perigo && distOrigem <= RAIO_ZA / 4 && distOrigem >= RAIO_AP) {
        printf("\n");
        dist_toque = distancia(x,x1,y,y1);
        printf("TRAJETORIA INTERCEPTARA A ZONA AP \n");
        printf("Distância atual à AP: %.2f \n", dist_toque);
        printf("Interseção ocorrerá em %.2f segundos \n", dist_toque/speed);
        printf("O toque ocorrerá na coordenada (%.2f , %.2f) \n", x, y);
        printf("\n");
        printf("********************************************************************************* \n");
        printf("ALERTA| ALERTA| ALERTA| ALERTA| ALERTA| ALERTA| ALERTA: \n");
      ...
      } else if (perigo && distOrigem <= RAIO_ZA / 2 && distOrigem >= RAIO_AP) {
        printf("\n");
        dist_toque = distancia(x,x1,y,y1);
        printf("TRAJETORIA INTERCEPTARA A ZONA AP \n");
        printf("Distância atual à AP: %.2f \n", dist_toque);
        ...
        printf("********************************************************************************* \n");
        printf("\n");
      } else if (perigo && distOrigem <= RAIO_ZA && distOrigem >= RAIO_AP ) {
        printf("\n");
        dist_toque = distancia(x,x1,y,y1);
        printf("TRAJETORIA INTERCEPTARA A ZONA AP \n");
        printf("Distância atual à AP: %.2f \n", dist_toque);
        ...
        if(distOrigem >= RAIO_AP && dist) printf("TRAJETORIA NÃO INTERCEPTA A ZONA AP \n");
      }
    }
